		...
		<table class="table" id="booksTable">
			...
			<tbody>
				...
				<tr>
					...
					<td align="center"><button type="button" class="btn btn btn-primary" data-toggle="modal" data-target="#myModal1" href="addbookcopy.jsp?bookId=<%=book.getBookId()%>">Add Book Copy</button></td>
					<td><button type="button" class="btn btn-sm btn-danger" onclick="javascript:location.href='deleteBook?bookId=<%=book.getBookId()%>';">Delete Book</button>
				</tr>
				<%
					}
				%>
